...
async def get_thumb(videoid, user_id):
    ...
    try:
        ...
        try:
            title_font = ImageFont.truetype("RessoMusic/assets/font3.ttf", 32)
            regular_font = ImageFont.truetype("RessoMusic/assets/font4.ttf", 18)
        except OSError:
        ...
        icons_path = "RessoMusic/assets/play_icons.png"
        ...
        font = ImageFont.truetype("RessoMusic/assets/font3.ttf", 28)  
        text = " "
