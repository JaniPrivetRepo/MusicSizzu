...
async def gen_thumb(videoid):
    ...
    try:
        ...
        try:
            font_title = ImageFont.truetype("RessoMusic/assets/font.ttf", 45)
            font_details = ImageFont.truetype("RessoMusic/assets/font2.ttf", 30)
            font_watermark = ImageFont.truetype("RessoMusic/assets/font2.ttf", 25)
        except:
